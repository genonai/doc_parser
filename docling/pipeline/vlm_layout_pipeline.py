...
from docling.models.vlm_layout_model import VLMLayoutModel
...
class VLMLayoutPipeline(PaginatedPipeline):
    def __init__(self, pipeline_options: PdfPipelineOptions):
        ...
        self.build_pipe = [
            ...
            VLMLayoutModel(pipeline_options=pipeline_options),
            ...
            for page in conv_res.pages:
                if page.assembled is not None:
                    for el in page.assembled.body:
                        all_body.append(el)
                    for el in page.assembled.headers:
