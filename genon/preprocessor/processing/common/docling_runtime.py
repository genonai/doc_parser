...
from genon.preprocessor.processing.common import runtime_kwargs as rk
from genon.preprocessor.processing.enrichment.custom_fields_enricher import (
    build_document_custom_fields_enrichers,
)
from genon.preprocessor.processing.enrichment.doc_summary import (
    DocSummaryEnricher,
    DocSummaryOptions,
)
...
class DoclingRuntimeBase:
    ...
    def __init__(self, config: dict | None = None, config_path: str | None = None):
        ...
        # 해석은 processing/common/pipeline_setup.py 로 모았다(조정 지점은 yaml 의 ocr 섹션).
        ...
        # 해석·적용은 processing/common/pipeline_setup.py 로 모았다(조정 지점은 yaml 의 layout 섹션).
        ...
        # pdf_pipeline 섹션 해석은 processing/common/pipeline_setup.py 로 모았다.
