...
class DocumentProcessor:
    ...
    async def compose_vectors(
        ...
        **kwargs: dict,
        ...
        manual_source_name = kwargs.get("file_name", "[Error] No File Name")
        print("@@@@ ", manual_source_name)
        global_metadata.update(extract_manual_metadata_from_filename(manual_source_name))
